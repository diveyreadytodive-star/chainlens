...
작성 기준: 2026-09-12. 구현물은 Vercel 웹 데모와 Chrome Manifest V3 확장이다. 신청서 업로드·제출과 Chrome Web Store 등록은 하지 않았다.
...
| GitHub 또는 서비스 데모 링크 | https://chainlens-lyart.vercel.app |
| 링크 접근 확인 상태 | 비로그인 공개 접속, health·examples API와 확장 ZIP 다운로드 확인 완료 |
...
| 구분 | 내용 | 현재 근거 |
|---|---|---|
| 웹 데모 | Vercel Functions, Node.js HTTP, HTML/CSS/JavaScript UI, Ethereum JSON-RPC, BigInt 수량·수수료 계산 | production 배포, app 검사 28/28 통과 |
...
선택 개발증빙은 GitHub·시연 영상·프로토타입 링크 중 최대 1건이다. 제출 링크로 비로그인 Vercel 웹 데모를 사용한다. 영상과 Web Store 등록은 현재 없으며, 공개 데모가 신청서 최종 제출을 뜻하지는 않는다.
